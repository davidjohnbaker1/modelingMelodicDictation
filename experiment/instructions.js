...
var maininstructions ={
    type: 'instructions',
    pages: ['<p align="justify">For this experiment you will perform FIVE melodic dictations on relatively short melodies.</p><p align="justify">Each melody will be played FIVE times. Prior to hearing each melody, the key will be established via a I &mdash; IV &mdash; I &mdash; V7 &mdash; I progression. Once the key is established, you will hear a two bars for nothing played by a clave. For example, if the melody is in 6/8 time,  you will hear six clave clicks representing the level of the beat and then  the melody will begin to play. The times signature, mode, and key signature of each melody is provided on your paper. After each melody is played you will have 20 seconds before the next hearing. A triangle sound will play before every hearing. Before the final hearing of the melody the triangle will be played twice. After the last hearing of the melody, you will have two minutes to make any needed corrections to your paper.</p>','<p align="justify">THE EXPERIMENTER WILL HELP GUIDE YOU AS TO WHAT PAGE TO USE FOR YOUR DICATION</p><p align="justify"> A THIS SOUND WILL PLAY WHEN THE NEW MELODY IS ABOUT TO START. It is very important that once you have moved on to the next melody that you do not correct any previous melodies. Changes outside of the allotted time will corrupt any data we are trying to collect.<p>Finally, unlike melodic dictations you have performed in class, you are not expected to be able to dictate the entire melody in the allotted time! Please just do your best to dictate as much as possilble. The experiment is set up in such a way that completing the entire dictation is near impossible in the time given.</p> If you understand this, press next.</p>',
